shinyUI(
	fluidPage( id= "main-container",
	  ...
	  fluidRow(
	    column(6,tags$div(id="shiny_place"), class="container-box"),
	    column(6,tags$div(id="shiny_hobby"), class="container-box")
	  ),
	  fluidRow(
	    column(6,tags$div(id="shiny_field"), class="container-box"),
